...
public class RainbowPublicMap
{
    ...
    public RainbowPublicMap(RainbowParameters params, SecureRandom random)
    {
    ...
    public short[] publicMap(RainbowPublicKeyParameters pk, short[] signature)
    {
        ...
        SecureRandom pk_random = RainbowUtil.getSecureRandom(this.random.getAlgorithm(), pk.getPk_seed());
