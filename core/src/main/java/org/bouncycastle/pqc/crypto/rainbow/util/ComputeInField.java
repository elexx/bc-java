...
public class ComputeInField
{
     ...
     * <p>
     * It is used in solveEquation as well as in the function for
        ...
        throws RuntimeException
    {
        ...
        //elimination operations to modify A so that it contains only 0s under the diagonal
     ...
     * where A is a triangle-matrix (contains only zeros under the diagonal)
     * and b is a vector
     * <p>
