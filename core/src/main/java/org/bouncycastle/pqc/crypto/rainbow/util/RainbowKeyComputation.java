...
public class RainbowKeyComputation
{
    ...
    {
        this.s1 = org.bouncycastle.pqc.rainbow.util.RainbowUtil.generate_random_2d(sk_random, o1, o2);
        this.t1 = org.bouncycastle.pqc.rainbow.util.RainbowUtil.generate_random_2d(sk_random, v1, o1);
        this.t2 = org.bouncycastle.pqc.rainbow.util.RainbowUtil.generate_random_2d(sk_random, v1, o2);
        this.t3 = org.bouncycastle.pqc.rainbow.util.RainbowUtil.generate_random_2d(sk_random, o1, o2);
    }

    private void generate_B1_and_B2(SecureRandom pk_random)
    {
        this.l1_Q1 = org.bouncycastle.pqc.rainbow.util.RainbowUtil.generate_random(pk_random, o1, v1, v1, true);
        this.l1_Q2 = org.bouncycastle.pqc.rainbow.util.RainbowUtil.generate_random(pk_random, o1, v1, o1, false);
        this.l2_Q1 = org.bouncycastle.pqc.rainbow.util.RainbowUtil.generate_random(pk_random, o2, v1, v1, true);
        this.l2_Q2 = org.bouncycastle.pqc.rainbow.util.RainbowUtil.generate_random(pk_random, o2, v1, o1, false);
        this.l2_Q3 = org.bouncycastle.pqc.rainbow.util.RainbowUtil.generate_random(pk_random, o2, v1, o2, false);
        this.l2_Q5 = org.bouncycastle.pqc.rainbow.util.RainbowUtil.generate_random(pk_random, o2, o1, o1, true);
        this.l2_Q6 = org.bouncycastle.pqc.rainbow.util.RainbowUtil.generate_random(pk_random, o2, o1, o2, false);
    }
    ...
    private void calculate_F_from_Q()
    {
        // Layer 1
        // F1 = Q1
        this.l1_F1 = org.bouncycastle.pqc.rainbow.util.RainbowUtil.cloneArray(this.l1_Q1);
        ...
        // F1 = Q1
        this.l2_F1 = org.bouncycastle.pqc.rainbow.util.RainbowUtil.cloneArray(this.l2_Q1);
    ...
    {
        SecureRandom sk_random = org.bouncycastle.pqc.rainbow.util.RainbowUtil.getSecureRandom(this.random.getAlgorithm(), this.sk_seed);
        SecureRandom pk_random = RainbowUtil.getSecureRandom(this.random.getAlgorithm(), this.pk_seed);
